...
if client:IsCombine() then
		client:SetSelfDarkRPVar("Energy", math.Clamp((client:GetDarkRPVar("Energy") or 100) + (80), 0, 100))
                                client:AddMoney(500)
                                client:Notify("Because you are a CP you recived your hourly paycheck (500) for this ration.")
