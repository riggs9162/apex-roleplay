...
function ENT:CanTool(client, tr, mode)
...
local function CanProperty(client, act, ent)
...
properties.Add( "zar3_collision_off", 
{
	...
	Filter = 
		function(self, ent, client)
			...
			if not gamemode.Call("CanProperty", client, "zar3_nocollide", FindAR3At(clamp)) then 
				return false 
			end
