...
if client:Team() == TEAM_VORT then
		client:SetSelfDarkRPVar("Energy", math.Clamp((client:GetDarkRPVar("Energy") or 100) + (40), 0, 100))
                                client:AddMoney(100)
                                client:Notify("Because you are a citizen you recived your hourly paycheck (100) for this ration.")
