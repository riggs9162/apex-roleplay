...
concommand.Add( "apex_atm_nopin", function( client, cmd, args )
	...
	button5.DoClick = function()
		RunConsoleCommand( "apex_atm_setpin", myText5:GetValue() )
	end

end )

concommand.Add( "apex_atm_open", function( client, cmd, args )
	if ( !AreWeNearATM() ) then chat.AddText( "You must be near an ATM to use it!" ) return end
	...
	myText1.OnEnter = function()
		RunConsoleCommand( "apex_atm_login", util.CRC( myText1:GetValue() ), List.CurData )
	end
	...
	button1.DoClick = function()
		Derma_Query( "Are you sure you want to print all ATM PIN codes?", "Print PIN Codes",
			"Yes", function()
				RunConsoleCommand( "apex_atm_pincodes_send" )
			end,
			"No", function() end
		)
	end
	...
	button2.DoClick = function()
		Derma_Query( "Are you sure you want to print all ATM banked money?", "Print Banked Money",
			"Yes", function()
				RunConsoleCommand( "apex_atm_money_send" )
			end,
			"No", function() end
		)
	end
	...
	button3.DoClick = function()
		Derma_Query( "Are you sure you want to remove all ATMs from the map?", "Remove ATMs",
			"Yes", function()
				RunConsoleCommand( "apex_atm_removeall" )
			end,
			"No", function() end
		)
	end
	...
	button4.DoClick = function()
		Derma_Query( "Are you sure you want to respawn all ATMs from a saved file?", "Respawn ATMs",
			"Yes", function()
				RunConsoleCommand( "apex_atm_respawnall" )
			end,
			"No", function() end
		)
	end
	...
	button3_add.DoClick = function()
		Derma_Query( "Are you sure you want to save all ATM spawn positions for this map?", "Save ATM Spawns",
			"Yes", function()
				RunConsoleCommand( "apex_atm_savespawns" )
			end,
			"No", function() end
		)
	end
	...
	button4_add.DoClick = function()
		Derma_Query( "Are you sure you want to delete all ATM spawn positions for this map?", "Delete ATM Spawns",
			"Yes", function()
				RunConsoleCommand( "apex_atm_removespawns" )
			end,
			"No", function() end
		)
	end
	...
	myText11.OnEnter = function()
		Derma_Query( "Are you sure you want to set the PIN for this account?", "Set PIN",
			"Yes", function()
				RunConsoleCommand( "apex_atm_admin_setpin", List2.CurData, myText11:GetValue() )
			end,
			"No", function() end
		)
	end
	...
	button6.DoClick = function()
		Derma_Query( "Are you sure you want to enter this account without entering PIN?", "Enter Account",
			"Yes", function()
				RunConsoleCommand( "apex_atm_admin_account", List2.CurData )
			end,
			"No", function() end
		)
	end
	...
	button7.DoClick = function()
		Derma_Query( "Are you sure you want to reset the PIN for this account?", "Reset PIN",
			"Yes", function()
				RunConsoleCommand( "apex_atm_admin_resetpin", List2.CurData )
			end,
			"No", function() end
		)
	end
	...
	button8.DoClick = function()
		Derma_Query( "Are you sure you want to reset the money for this account?", "Reset Money",
			"Yes", function()
				RunConsoleCommand( "apex_atm_admin_resetmoney", List2.CurData )
			end,
			"No", function() end
		)
	end
...
concommand.Add("apex_atm_account",function ( client, cmd, args )
	if ( !AreWeNearATM() ) then chat.AddText( "You must be near an ATM to use it!" ) return end
	if ( IsValid( DermaPanel5 ) ) then
		DermaPanel5:SetVisible( false )
		DermaPanel5:Close()
	...
	myText.OnEnter = function()
		RunConsoleCommand("apex_atm_deposit", args[1], args[2], tonumber( myText:GetValue() ) )
	end
	...
	myText2.OnEnter = function()
		RunConsoleCommand("apex_atm_withdraw", args[1], args[2], tonumber( myText2:GetValue() ) )
	end
