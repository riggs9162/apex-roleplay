...
-- |_ _or __| / \ | \_/ |  / _| / \ | o \ o \\ V /
--  | | | _| | o or \_/ | ( |_n| o or   /   / \ / 
--  |_| |___or_n_or_| |_|  \__/|_n_or_|\\_|\\ |_|  2012
--
--
...
SKIN.PrintName 		= "Cortex"
SKIN.Author 		= "Cookie"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "hl2rp/DermaSkin.png" )

SKIN.bg_color 					= Color( 255, 255, 255, 255 )
SKIN.bg_color 					= Color( 255, 255, 255, 255 )
SKIN.bg_color 					= Color( 255, 255, 255, 255 )
...
SKIN.colCollapsibleCategory		= Color( 109, 165, 214, 20 )
...
function SKIN:PaintCollapsibleCategory( panel, w, h )
	...
	if ( !panel:GetExpanded() and h < 40 ) then
...
derma.DefineSkin( "Cortex", "Cortex's Derma VGUI", SKIN )