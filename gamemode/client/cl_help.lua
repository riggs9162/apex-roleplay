...
addLabel(HELP_CATEGORY_ADMINCMD, "apex_own - Own the door you're looking at.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_unown - Remove ownership from the door you're looking at.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_add_owner [Nick|SteamID|UserID] - Add a co-owner to the door you're looking at.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_remove_owner [Nick|SteamID|UserID] - Remove co-owner from door you're looking at.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_lock - Lock the door you're looking at.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_unlock - Unlock the door you're looking at.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_tell [Nick|SteamID|UserID] <Message> - Send a noticeable message to a named player.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_remove_letters [Nick|SteamID|UserID] - Remove all letters for a given player (or all if none specified).")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_arrest [Nick|SteamID|UserID] <Length> - Arrest a player for a custom amount of time.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_unarrest [Nick|SteamID|UserID] - Unarrest a player.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_set_money [Nick|SteamID|UserID] <Amount> - Set a player's money to a specific amount.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_set_salary [Nick|SteamID|UserID] <Amount> - Set a player's Roleplay Salary.")
addLabel(HELP_CATEGORY_ADMINCMD, "apex_set_name [Nick|SteamID|UserID] <Name> - Set a player's RP name.")
