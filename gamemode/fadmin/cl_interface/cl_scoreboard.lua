...
function FAdmin.ScoreBoard.ShowScoreBoard()
	...
	FAdmin.ScoreBoard.Controls.ServerSettings:SetMouseInputEnabled( true )
	FAdmin.ScoreBoard.Controls.ServerSettings:SetZPos( 100 )


	FAdmin.ScoreBoard.Controls.ServerSettings.DoClick = function()
