FAdmin.StartHooks["CleanUp"] = function()
	...
	FAdmin.ScoreBoard.Server:AddServerAction("Clear decals", "FAdmin/icons/CleanUp", Color(155, 0, 0, 255), true, function(client, button)
		RunConsoleCommand("_FAdmin", "ClearDecals")
	end)
	
	FAdmin.ScoreBoard.Server:AddServerAction("Stop all sounds", "FAdmin/icons/CleanUp", Color(155, 0, 0, 255), true, function(client, button)
	...
	FAdmin.ScoreBoard.Server:AddServerAction("Clean up server", "FAdmin/icons/CleanUp", Color(155, 0, 0, 255), true, function(client, button)
