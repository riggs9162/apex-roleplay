local function ChangeLevel(client, cmd, args)
	if not FAdmin.Access.PlayerHasPrivilege(client, "changelevel") then FAdmin.Messages.SendMessage(client, 5, "No access!") return end
