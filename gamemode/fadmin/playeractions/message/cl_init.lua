local function MessageGui(client)
	...
	function OK:DoClick()
		frame:Close()
		RunConsoleCommand("_FAdmin", "Message", client:SteamID64(), MsgType, TextBox:GetValue())
	end
end
...
FAdmin.StartHooks["zzSendMessage"] = function()
	...
	FAdmin.ScoreBoard.Player:AddActionButton("Send message", "FAdmin/icons/Message", Color(0, 200, 0, 255),
		function(client) return FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "Message") end, function(client, button)
			MessageGui(client)
		end
	)
end