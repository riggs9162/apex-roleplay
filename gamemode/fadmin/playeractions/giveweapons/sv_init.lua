local function GiveWeapon(client, cmd, args)
	if not FAdmin.Access.PlayerHasPrivilege(client, "giveweapon") then FAdmin.Messages.SendMessage(client, 5, "No access!") return end
	...
	FAdmin.Messages.ActionMessage(client, targets, "You gave %s a "..weapon, "%s gave you a "..weapon, "Gave %s a "..weapon)
end

local function GiveAmmo(client, cmd, args)
	if not FAdmin.Access.PlayerHasPrivilege(client, "giveweapon") then FAdmin.Messages.SendMessage(client, 5, "No access!") return end
	...
	FAdmin.Messages.ActionMessage(client, targets, "You gave %s "..amount.." "..ammo.. " ammo", "%s gave you ".. amount.." "..ammo.. " ammo", "Gave %s "..amount.." "..ammo)
end
