...
function playerMeta:syncVars()
	for entity, data in pairs(apex.net) do
...
function entityMeta:sendNetVar(key, receiver)
	netstream.Start(receiver, "nVar", self:EntIndex(), key, apex.net[self] and apex.net[self][key])
end

function entityMeta:clearNetVars(receiver)
	if apex.net[self] then apex.net[self] = nil end
