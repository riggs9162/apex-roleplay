...
apex.anim.citizen_female = {
	...
	glide = ACT_GLIDE,
	vehicle = apex.anim.citizen_male.vehicle
}
apex.anim.metrocop = {
	normal = {
		[ACT_MP_STAND_IDLE] = {ACT_IDLE, ACT_IDLE},
	...
	vehicle = {
		...
		["prop_vehicle_jeep"] = {ACT_COVER_PISTOL_LOW, Vector(18, -2, 4)},
                                ["Chair_Office2"] = {ACT_COVER_PISTOL_LOW, Vector(5, 0, -5)},
...
local vectorAngle = FindMetaTable("Vector").Angle -- MAKES LEGS LESS SPAZZSY
local normalizeAngle = math.NormalizeAngle

function GM:CalcMainActivity(client, velocity) -- MAKES LEGS ANIMATIONSN WORK :)))
...
function apex.anim.setModelClass(model, class)
	if (!apex.anim[class]) then
...
function apex.anim.getModelClass(model)
...
apex.anim.setModelClass("models/police.mdl", "metrocop")

apex.anim.setModelClass("models/dpfilms/metropolice/hdpolice.mdl", "metrocop")
apex.anim.setModelClass("models/dpfilms/metropolice/police_bt.mdl", "metrocop")
apex.anim.setModelClass("models/dpfilms/metropolice/elite_police.mdl", "metrocop")
apex.anim.setModelClass("models/dpfilms/metropolice/civil_medic.mdl", "metrocop")
apex.anim.setModelClass("models/dpfilms/metropolice/hl2concept.mdl", "metrocop")
apex.anim.setModelClass("models/dpfilms/metropolice/phoenix_police.mdl", "metrocop")
apex.anim.setModelClass("models/dpfilms/metropolice/policetrench.mdl", "metrocop")
apex.anim.setModelClass("models/dpfilms/metropolice/hl2beta_police.mdl", "metrocop")




apex.anim.setModelClass("models/dpfilms/metropolice/rtb_police.mdl", "metrocop")
apex.anim.setModelClass("models/combine_super_soldier.mdl", "overwatch")
apex.anim.setModelClass("models/combine_soldier_prisonGuard.mdl", "overwatch")
apex.anim.setModelClass("models/combine_soldier.mdl", "overwatch")
apex.anim.setModelClass("models/vortigaunt.mdl", "vort")
apex.anim.setModelClass("models/vortigaunt_blue.mdl", "vort")
apex.anim.setModelClass("models/vortigaunt_doctor.mdl", "vort")
apex.anim.setModelClass("models/vortigaunt_slave.mdl", "vort")
...
do
	...
	function playerMeta:forceSequence(sequence, callback, time, noFreeze)
		...
		if (sequence and sequence > 0) then
			...
			self.hl2rpSeqCallback = callback
	...
	function playerMeta:leaveSequence()
		...
		if (self.hl2rpSeqCallback) then
			self:hl2rpSeqCallback()
		end
	end
...
function GM:DoAnimationEvent(client, event, data)
	...
	local class = apex.anim.getModelClass(model)
	...
	if (class == "player") then
		...
		if (IsValid(weapon)) then
			...
			local animation = apex.anim[class][holdType]
