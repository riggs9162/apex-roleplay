...
local MySQLConfig = MySQLConfig
if MySQLConfig.EnableMySQL then
	require("mysqloo")
	mysqlOO = mysqloo
end
...
function initialize()
	if MySQLConfig.EnableMySQL then
		timer.Simple(1, function()
			connectToMySQL(MySQLConfig.Host, MySQLConfig.Username, MySQLConfig.Password, MySQLConfig.Database_name, MySQLConfig.Database_port)
		end)
	else
