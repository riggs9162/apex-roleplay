...
concommand.Add("hl2rp_togglethirdperson", function()
	local convar = GetConVar("hl2rp_thirdperson"):GetInt() or false
	if convar == 0 then
		RunConsoleCommand("hl2rp_thirdperson", 1)
	else
		RunConsoleCommand("hl2rp_thirdperson", 0)
	end
end)

net.Receive( "thirdPerson", function( len, client )
