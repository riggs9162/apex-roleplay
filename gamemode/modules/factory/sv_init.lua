...
local function LoadFactory()
	...
	CreateEnt("hl2rp_rationoven", Vector(3181.656250, 5793.531250, 341.937500), Angle(0, -45, 0))

	CreateEnt("hl2rp_rationoven_exit", Vector(3228.6, 5463.343750, 341.937500), Angle(0, 90, 0))
