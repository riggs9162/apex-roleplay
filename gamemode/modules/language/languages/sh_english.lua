...
local english = {
	...
	payday_message = "You received your salary of %s! It has been added to your bank account.",
	...
	lockdown_started = "The Administrator has initiated a Lockdown, please return to your homes!",
	...
	-- F4menu
	-- Tab 1
	give_money = "Give tokens to the player you're looking at",
	drop_money = "Drop tokens",
...
apex.language.Register("en", english)