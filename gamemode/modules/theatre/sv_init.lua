...
concommand.Add("hl2rp_theatre_play", function(client,cmd,args)
    if not nearConsole(client) then return end
...
concommand.Add("hl2rp_theatre_stop", function(client,cmd,args)
    if not nearConsole(client) then return end
    Theatre_Speaker1:StopSound(Theatre_Speaker1.soundscript or "")
    Theatre_Speaker2:StopSound(Theatre_Speaker2.soundscript or "")
end)

concommand.Add("hl2rp_theatre_curtaintoggle", function(client,cmd,args)
    if not nearConsole(client) then return end
    Theatre_Curtain1:Fire("toggle")
end)

concommand.Add("hl2rp_theatre_lightsoff", function(client,cmd,args)
    if not nearConsole(client) then return end
...
concommand.Add("hl2rp_theatre_lightson", function(client,cmd,args)
    if not nearConsole(client) then return end
