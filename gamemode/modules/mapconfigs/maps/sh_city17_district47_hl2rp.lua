...
maphl2config["apex_city17_district47_hl2rp"] = {
...
id = 1920,
check = function(p)
	if p:IsCombine() or p:IsAdmin() then
...
check = function(p)
	if p:IsCombine() or p:IsAdmin() then
		if string.match( p:Name(), "SeC" ) or string.match( p:Name(), "CmD" ) or string.match( p:Name(), "OWC" ) or string.match( p:Name(), "CPC17-DvL-JURY" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
...
check = function(p)
	if p:IsCombine() or p:IsAdmin() then
		if string.match( p:Name(), "SeC" ) or string.match( p:Name(), "CmD" ) or string.match( p:Name(), "OWC" ) or string.match( p:Name(), "CPC17-DvL" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
