...
/*AddEntity("Microwave", {
	...
	max = 1,
	cmd = "/buymicrowave",
	customCheck = function(client) if client:Team() == TEAM_CP and CPMenuPlyTable and CPMenuPlyTable[client:SteamID64()] and CPMenuPlyTable[client:SteamID64()]["Division"] == 2 then return true else return false end end
})*/