hook.Add("HUDPaint", "HUD911", function()
	...
	for k,v in pairs ( player.GetAll( ) ) do
		if v:GetNWBool("Called911") and LocalPlayer():IsCombine() then
			...
			draw.DrawText("Civil Protection REQUEST: "..v:Nick(), "ChatFont", scrn.x+20, scrn.y, Color(255,255,255), TEXT_ALIGN_CENTER)
...
if LocalPlayer():IsCombine() and GetGlobalBool("jw",false)==true then
